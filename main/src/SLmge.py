...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.readCard = QtWidgets.QPushButton(self.centralwidget)
        self.readCard.setObjectName("readCard")
        self.gridLayout.addWidget(self.readCard, 2, 4, 1, 1)
        ...
        MainWindow.setTabOrder(self.wakeUP, self.readCard)
        MainWindow.setTabOrder(self.readCard, self.showSQL)
        MainWindow.setTabOrder(self.showSQL, self.serialPrint)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "主程序"))
        self.readCard.setText(_translate("MainWindow", "读卡"))
